...
class OverTimeController extends GetxController{
  ...
  List<OverTime> overtimeList = <OverTime>[];
  ...
  initPage()async{
    ...
    overtimeList = await Api.getOvertime(Global.currentMonth.year, Global.currentMonth.number);
    loading(false);
  ...
  refreshData(int month, int year)async{
    ...
    overtimeList = await Api.getOvertime(year, month);
    loading(false);
  }
}